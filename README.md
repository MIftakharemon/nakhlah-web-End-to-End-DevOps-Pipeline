...
```bash
git clone https://github.com/MIftakharemon/nakhlah-web-End-to-End-DevOps-Pipeline.git
cd nakhlah-web-End-to-End-DevOps-Pipeline
```
...
```
nakhlah-web-End-to-End-DevOps-Pipeline/
├── .github/workflows/
